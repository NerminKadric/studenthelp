...
<body>
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand">Student Help</a>
            <div class="d-flex login-div">
                <a href="login.php" class="btn btn-outline-success">Login</a>
                <a href="register.php" class="btn btn-outline-success register-btn">Registracija</a>
            </div>
        </div>
    </nav>
    <div class="student-help-div">
        <h1>Best Student Helping Tool</h1>
    </div>
